function Home() {
  return (
    <div>
      <h1 style={{color: '#ffab00'}}>Feliz 42 anos pra mãe mais fantástica desse mundoooo!!!!! </h1>
      ...
      <p style={{fontFamily: 'Arial'}}> 
        ...
        <br/>Eu amo muitoooooooo você mãe, você eh a melhor que alguém poderia desejar ter!!!!!<br/>

        <br/><span style={{color: '#ff0000'}}>Eu amo muitoooooooo você!!!!!!</span> <br/>
      </p>
    </div>
